...
=== "Gradle"
    ...
    ```groovy
    implementation 'ru.icc.regtab:regtab:0.4.0'
    ```
...
!!! note "Status"
    Current release: **0.4.0** · License: **MIT** · [Maven Central](https://central.sonatype.com/artifact/ru.icc.regtab/regtab) · [GitHub](https://github.com/regtab/jregtab)
