...
public final class TablePattern {
    ...
    public static final class CellItemBuilder {
        ...
        /**
         * Auxiliary helper item(s): cell text becomes {@link ru.icc.regtab.itm.model.semantics.item.ItemType#AUXILIARY} (ITM auxiliary / вспомогательные).
         */
    ...
    public static final class CompoundBuilder {
        ...
        /** Attribute token (cell substring becomes {@link ru.icc.regtab.itm.model.semantics.item.ItemType#ATTRIBUTE}). */
        public CompoundBuilder attr() {
