...
record CellGroupSpec(
        ...
        /** Emit {@link ru.icc.regtab.itm.semantics.item.ItemType#ATTRIBUTE} items from cell text. */
        boolean attributeItem,
        /** Emit {@link ru.icc.regtab.itm.semantics.item.ItemType#AUXILIARY} helper items (ITM auxiliary). Mutually exclusive with {@code attributeItem}. */
