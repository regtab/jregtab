...
/**
 * Task 123: cross-tabulation with compound YEAR&lt;br&gt;MONTH header cell and
 * compound MIN-MAX&lt;br&gt;AVE data cell. YEAR extracted with SUBSTR(0,4).
 ...
 * <pre>
 * [ []+ ]
 * [ [] [VAL=SUBSTR(0,4): 'YEAR'-&gt;AVP '&lt;br&gt;' VAL: 'MONTH'-&gt;AVP]{4} [] ]
 * [ [VAL: 'INDICATOR'-&gt;AVP]
 *   [VAL: 'MIN'-&gt;AVP '-' VAL: 'MAX'-&gt;AVP '&lt;br&gt;' VAL: 'AVE'-&gt;AVP, (CL*,ROW,COL&amp;R1*)-&gt;REC]{4} [] ]+
 * </pre>
 */
