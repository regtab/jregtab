 ...
 * <p>
 * Fixtures: {@code src/test/resources/tasks/task_90/}
 * ATP: {@link ru.icc.regtab.atp.AtpTask90Test}
 * <pre>
 * [ [VAL=REPL('\*','') : BW*-&gt;SUFFIX('/'), ()-&gt;REC]+ ]
 * [ [AUX]+ ]+
 * </pre>
 */
public class RtlTask90Test extends RtlTaskBase {

    @Override
    protected String taskId() { return "90"; }
