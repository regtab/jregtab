 ...
 * REC on AVE collects same-row INDICATOR/UNIT (ROW&amp;C0*), same-subrow left items MIN/MAX
 * (-LT&amp;C-2..-1*), and same-column LOCATION (COL).
 * <p>
 ...
 *     [VAL: 'AVE'-&gt;AVP, (ROW&amp;C0*, -LT&amp;C-2..-1*, COL)-&gt;REC] }+ ]+
 * </pre>
 */
