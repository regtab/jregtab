 ...
 * <p>
 * Fixtures: {@code src/test/resources/tasks/task_093/}
 * ATP: {@link ru.icc.regtab.atp.AtpTask093Test}
 * <pre>
 * { [ { [!BLANK? ATTR]+ [BLANK?] }+ ]
 ...
 */
public class RtlTask093Test extends RtlTaskBase {

    @Override
    protected String taskId() { return "093"; }
