 ...
 * <pre>
 * [ [] [AUX]+ ]
 * [ [VAL : ROW*->REC, (BW &amp; STR)->CONCAT, 'ID'->AVP]
 ...
 * all VAL cells from the same row, while CONCAT (BW &amp; STR) merges the paired row below.
 ...
 */
public class RtlTask53Test extends RtlTaskBase {
