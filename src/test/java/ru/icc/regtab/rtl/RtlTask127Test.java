 ...
 * (PREFIX from above), and two symmetric blocks of MIN-MAX\nAVE data cells.
 * REC for the first block: (CL*,ROW{3},COL,COL&amp;R2,ROW&amp;C5).
 * REC for the second block: (CL*,ROW{2},ROW&amp;C6,COL,COL&amp;R2,ROW&amp;C10).
 * <p>
